...
//   return (
//     <nav className="navbar">
//       <div className="logo">EcoBloom</div>
//       <ul className="nav-links">
//         <Link to="/"><li>Home</li></Link>
//         <Link to="/calculate"><li className="active">Calculate</li></Link>
//         <li>Points</li>
  ...
  return (
    <nav className="navbar">
      <div className="navbar-container">
        <div className="logo">
          <span className="logo-text">EcoBloom</span>
        ...
        <ul className="nav-links">
          ...
          <Link to="/learn-play">
            <li className={location.pathname === "/learn-play" ? "active" : ""}>Games</li>
          </Link>
          ...
          <div className={`dropdown-container ${showMoreDropdown ? "active" : ""}`} ref={moreRef}>
            ...
            {showMoreDropdown && (
              <div className="dropdown-menu">
                <Link to="/about" className="dropdown-item">About</Link>
                <Link to="/carbonInfo" className="dropdown-item">Carbon Footprint</Link>
                <Link to="/learn-play" className="dropdown-item">Learn & Play</Link>
              </div>
            )}
          </div>
